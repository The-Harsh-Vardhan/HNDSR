...
EXPORT_ONLY_FILES = (
    "scripts/export_showcase_repo.py",
)
TEXT_SUFFIXES = {".py", ".md", ".yaml", ".yml", ".json", ".ipynb", ".txt"}
PATH_REWRITES = (
    ("research_tracks/hndsr_rebuild/", ""),
    ("research_tracks.hndsr_rebuild.", ""),
)
...
def remove_export_only_files(dest_root: Path) -> None:
    for relative_path in EXPORT_ONLY_FILES:
...
def main() -> None:
    ...
    remove_export_only_files(dest_root)
