...
REQUIRED_NOTEBOOK_COMMANDS = (
    "research_tracks/hndsr_rebuild/scripts/validate_notebook_version.py",
    "research_tracks/hndsr_rebuild/scripts/train_baseline.py",
    "research_tracks/hndsr_rebuild/scripts/evaluate_run.py",
...
def validate_versioned_notebook(
    ...
    tracker_dir = repo_path("research_tracks/hndsr_rebuild/.tmp/notebook-readiness/tracker")
