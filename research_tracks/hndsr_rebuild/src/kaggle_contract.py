...
KERNEL_METADATA_PATH = "research_tracks/hndsr_rebuild/notebooks/versions/kernel-metadata.json"
DATASET_METADATA_PATH = "research_tracks/hndsr_rebuild/kaggle/dataset-metadata.json"
