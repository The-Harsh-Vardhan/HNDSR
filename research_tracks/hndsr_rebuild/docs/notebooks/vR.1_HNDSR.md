...
- Model lane: scratch `SR3` baseline from `research_tracks/hndsr_rebuild/src/models.py`
...
- Full training config: `research_tracks/hndsr_rebuild/configs/phase1_sr3_vr1_kaggle.yaml`
- Smoke training config: `research_tracks/hndsr_rebuild/configs/phase1_sr3_vr1_smoke.yaml`
- Bicubic control config: `research_tracks/hndsr_rebuild/configs/phase0_bicubic_vr1_kaggle_control.yaml`
- Fixed scale: `4x`
