...
This file is a repo-local operational snapshot, not the canonical source text.

- Prefer simple control flow and avoid recursion unless the bound is explicit and justified.
- Put hard limits on loops, retries, polling, traversal, and other work driven by external inputs.
...
- Enable strict warnings and static analysis early, and keep the codebase warning-free.
